...
The 'bronze_to_silver' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] bronze_to_silver_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/bronze_to_silver.job.yml). The schedule
